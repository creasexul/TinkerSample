 ...
 * @version 1.0
 */
internal class ResultService : DefaultTinkerResultService() {
    companion object {
        private const val TAG = "ResultService"
    }
        ...
        if (result.isSuccess) {
            ...
            if (checkIfNeedKill(result)) {
                if (TinkerUtil.background) {
                    ...
                    TinkerUtil.ScreenState(applicationContext, object : TinkerUtil.ScreenState.IOnScreenOff {
